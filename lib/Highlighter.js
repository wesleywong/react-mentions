...
var Highlighter = (_temp = _class = function (_Component) {
  ...
  Highlighter.prototype.render = function render() {
    ...
    if (selection.start === selection.end) {
      caretPositionInMarkup = (0, _utils.mapPlainTextIndex)(value, markup, selection.start, 'START', displayTransform, regex);
    }
    ...
    (0, _utils.iterateMentionsMarkup)(value, markup, textIteratee, mentionIteratee, displayTransform, regex);
